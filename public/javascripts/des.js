...
function crearLlaves(clave, consolaE){
  consolaE.append('Creando Llaves <br/>');
  ...
  //Ahora a picar
  consolaE.append('Primero pasaremos la clave a entero, cuyo resultado es: ');
  ...
  consolaE.append('Y hacemos la primera permutación, cuyo resultado es: <br/>');
  ...
  temp = ((left >>> 4) ^ right) & 0x0f0f0f0f; right ^= temp; left ^= (temp << 4);
    ...
    consolaE.append('Ahora creamos las 16 claves <br/>');
...
function encDes(tPlano, clave, encOrDenc, consolaE, vInicial, socket){
  ...
  var claves = crearLlaves(clave, consolaE);
